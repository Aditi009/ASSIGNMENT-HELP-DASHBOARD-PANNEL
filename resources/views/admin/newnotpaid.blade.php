  ...
  <div class="content-wrapper">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title" style="font-weight:bold;">NEW NOT PAID</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="example2" class="table table-bordered table-hover">
          ...
          <tr>
            ...
            <td><p style="color:#FF7F50;"></p>
        <button class="btn btn-danger btn-sm">New Student</button>
        </td>
            <td>
        <button class="btn btn-danger btn-sm">New</button>
        </td>
            <td></td>
            <td> <span>INR&nbsp;</span><span>&nbsp;</span>
        <button class="btn btn-success btn-sm" onclick="document.getElementById('changequote').style.display='block'" style="width:auto;">change</button><br>
     </td>
            <td>&nbsp;</td>
            <td></td>
        <td>&nbsp;</td>
...
@if ($item->table_status=="NewNotPaid")
